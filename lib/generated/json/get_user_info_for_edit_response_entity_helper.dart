...
getUserInfoForEditResponseEntityFromJson(GetUserInfoForEditResponseEntity data, Map<String, dynamic> json) {
	if (json['doctorExtend'] != null) {
		data.doctorExtend = GetUserInfoForEditResponseDoctorExtend().fromJson(json['doctorExtend']);
	}
	return data;
}

Map<String, dynamic> getUserInfoForEditResponseEntityToJson(GetUserInfoForEditResponseEntity entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['doctorExtend'] = entity.doctorExtend?.toJson();
	return data;
}

getUserInfoForEditResponseDoctorExtendFromJson(GetUserInfoForEditResponseDoctorExtend data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> getUserInfoForEditResponseDoctorExtendToJson(GetUserInfoForEditResponseDoctorExtend entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
	data['id'] = entity.id;
