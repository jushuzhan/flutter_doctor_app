...
class _ChatBottomInputWidgetState extends State<ChatBottomInputWidget>
  ...
  double _softKeyHeight = 200;//软键盘的高度
...
//    widget.controller.addListener(_onInputChange);
  ...
  Widget mRecordButton() {
    return new ImageButton(
      ...
      image: new AssetImage(ASSETS_IMG + "ic_audio.png"),
    );
  }
  ...
  Widget mKeyBoardButton() {
    return new ImageButton(
      ...
      image: new AssetImage(ASSETS_IMG + "ic_keyboard.png"),
    );
  }
  ...
  Widget mEmojiButton() {
    return new ImageButton(
      ...
      image: new AssetImage(ASSETS_IMG + "ic_emoji.png"),
    );
  }
    ...
    return StreamBuilder<String>(
      ...
      builder: (context, snapshot) {
        ...
        final extraButton = ImageButton(
            image: new AssetImage(ASSETS_IMG + "ic_add.png"),
            onPressed: () {
