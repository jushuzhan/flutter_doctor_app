...
String voiceIco = ASSETS_IMG + "ic_volume_1.png";
...
//  Recording _recording = new Recording();
  ...
  cancelRecord() async {
    ...
    File file = mLocalFileSystem.file(recording);
    file.delete();
    print("取消录音删除文件成功!");
    if (mOverlayEntry != null) {
  ...
  completeRecord() async {
    ...
    if (intervalTime < MIN_INTERVAL_TIME) {
      ...
      voiceIco = ASSETS_IMG + "ic_volume_wraning.png";
      showAnim = false;
      mButtonText = "按住录音";
      ...
      audioPlayer.setSourceDeviceFile(recording!);
      ...
      if(duration!=null){
        widget.onAudioCallBack?.call(file, duration.inSeconds);
      }
  ...
  void initState() {
    ...
    super.initState();
    _assetList.add(ASSETS_IMG + "ic_volume_1.png");
    _assetList.add(ASSETS_IMG + "ic_volume_2.png");
    _assetList.add(ASSETS_IMG + "ic_volume_3.png");
    _assetList.add(ASSETS_IMG + "ic_volume_4.png");
    _assetList.add(ASSETS_IMG + "ic_volume_5.png");
    _assetList.add(ASSETS_IMG + "ic_volume_6.png");
    _assetList.add(ASSETS_IMG + "ic_volume_7.png");
    _assetList.add(ASSETS_IMG + "ic_volume_8.png");
  }
      ...
      child: GestureDetector(
        ...
        onVerticalDragUpdate: (details) {
          ...
          if (offsetY >= 150) {
            ...
            voiceIco = ASSETS_IMG + "ic_volume_cancel.png";
            showAnim = false;
            mOverlayEntry?.markNeedsBuild();
            setState(() {
              mButtonText = "按住录音";
