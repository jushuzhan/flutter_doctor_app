...
class _ChangePhonePageState extends State<ChangePhonePage> {
  ...
  final TextEditingController _uVerificationCodeController = TextEditingController();
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text('请输入新的手机号码',style: TextStyle(
                  fontSize: 20,
            ...
            Container(
              ...
              child: Text('更换手机号码后，下次登录可使用新的手机号码登录。',style: TextStyle(
                fontSize: 12,
            ...
            Container(
              ...
              child: Text('当前手机号码：18600002306',style: TextStyle(
                  fontSize: 12,
                  color: Color(0xFF999999)
              ),),
            ),
                        ...
                        Expanded(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              contentPadding: EdgeInsets.only(left: 7), //TextField内容实现上下居中
                            ),
